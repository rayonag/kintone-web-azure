...
export const WaiverNotice = () => (
    <div className="p-2">
        ...
        <div className="m-3 mb-8 text-justify">
            ...
            <p>
                I am an adult of over 18 years of age and in consideration of my volunteering for the organization Bridges for Peace (hereinafter:
            ...
            <ol className="list-decimal text-left ml-5 mt-5">
                ...
                <li className="mb-3">
                    I will voluntarily assume all the risks associated with such participation in the organizations volunteer programme and I declare
                ...
                <li className="mb-3">
                    ...
                    myself or others if I volunteer. I further agree to abide by any established rules or regulations or the organization connected to
                ...
                <li className="mb-3">
                    ...
                    hereby release, waive, discharge, and covenant not to sue Bridges for Peace and/or their officers, directors agents, servants, and
                    employees (collectively, the "Releasees") from all liability, claims, demands, actions, or causes of action whatsoever arising out
                    of any damages, loss, or injury to me or to my property while participating in the volunteer programme of the organization whether
                    such damage, loss, or injury, results from the negligence of the Releasees or for any other cause.
                </li>
                <li className="mb-3">
                ...
                <li className="mb-3">
                    ...
                    organization with respect of any claim that any third party may have or bring against the Releasees which may result from my
