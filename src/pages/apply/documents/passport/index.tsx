    ...
    return (
        <Layout>
            <div className="relative flex flex-col items-center justify-center text-center min-h-screen bg-black text-white overflow-hidden">
                <span style={{ fontSize: '2rem' }}>Please Upload Copy of Your Passport</span>
                <span style={{ fontSize: '1.5rem' }}>Q. Which pages do I need to submit?</span>
                <span style={{ fontSize: '1.3rem' }}>A. Please upload your cover page, photo page, etc....</span>
