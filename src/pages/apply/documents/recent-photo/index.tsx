    ...
    return (
        <Layout>
            <div className="relative flex flex-col items-center justify-center text-center min-h-screen bg-black text-white overflow-hidden">
                <span style={{ fontSize: '2rem' }}>Please Upload Your Recent Photo</span>
                <span style={{ fontSize: '1.5rem' }}>Check before you upload review the followings:</span>
                <span style={{ fontSize: '1.3rem' }}>It needs to be a recent photo taken within the last six months.</span>
                <span style={{ fontSize: '1.3rem' }}>It needs to be...</span>
                <span style={{ fontSize: '1.3rem' }}>Make sure...</span>
